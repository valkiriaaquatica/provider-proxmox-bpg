...
type EnvironmentMetricsServerInitParameters struct {
	...
	InfluxTokenSecretRef *v1.LocalSecretKeySelector `json:"influxTokenSecretRef,omitempty" tf:"-"`

	// The InfluxDB access token (write-only). Cannot be used together with `influx_token`.
	InfluxTokenWoSecretRef *v1.LocalSecretKeySelector `json:"influxTokenWoSecretRef,omitempty" tf:"-"`
	...
	OpentelemetryHeadersSecretRef *v1.LocalSecretKeySelector `json:"opentelemetryHeadersSecretRef,omitempty" tf:"-"`
