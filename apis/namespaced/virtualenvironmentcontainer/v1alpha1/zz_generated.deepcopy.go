...
func (in *EnvironmentContainerInitParameters) DeepCopyInto(out *EnvironmentContainerInitParameters) {
	*out = *in
	...
	if in.Idmap != nil {
		...
		*out = make([]IdmapInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WaitForIP != nil {
		...
		*out = make([]WaitForIPInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EnvironmentContainerObservation) DeepCopyInto(out *EnvironmentContainerObservation) {
	*out = *in
	...
	if in.Idmap != nil {
		in, out := &in.Idmap, &out.Idmap
		*out = make([]IdmapObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WaitForIP != nil {
		in, out := &in.WaitForIP, &out.WaitForIP
		*out = make([]WaitForIPObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *EnvironmentContainerParameters) DeepCopyInto(out *EnvironmentContainerParameters) {
	*out = *in
	...
	if in.Idmap != nil {
		in, out := &in.Idmap, &out.Idmap
		*out = make([]IdmapParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.WaitForIP != nil {
		in, out := &in.WaitForIP, &out.WaitForIP
		*out = make([]WaitForIPParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdmapInitParameters) DeepCopyInto(out *IdmapInitParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdmapInitParameters.
func (in *IdmapInitParameters) DeepCopy() *IdmapInitParameters {
	if in == nil {
		return nil
	}
	out := new(IdmapInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdmapObservation) DeepCopyInto(out *IdmapObservation) {
	*out = *in
	if in.ContainerID != nil {
		in, out := &in.ContainerID, &out.ContainerID
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdmapObservation.
func (in *IdmapObservation) DeepCopy() *IdmapObservation {
	if in == nil {
		return nil
	}
	out := new(IdmapObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IdmapParameters) DeepCopyInto(out *IdmapParameters) {
	*out = *in
	if in.ContainerID != nil {
		in, out := &in.ContainerID, &out.ContainerID
		*out = new(float64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IdmapParameters.
func (in *IdmapParameters) DeepCopy() *IdmapParameters {
	if in == nil {
		return nil
	}
	out := new(IdmapParameters)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaitForIPInitParameters) DeepCopyInto(out *WaitForIPInitParameters) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaitForIPInitParameters.
func (in *WaitForIPInitParameters) DeepCopy() *WaitForIPInitParameters {
	if in == nil {
		return nil
	}
	out := new(WaitForIPInitParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaitForIPObservation) DeepCopyInto(out *WaitForIPObservation) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaitForIPObservation.
func (in *WaitForIPObservation) DeepCopy() *WaitForIPObservation {
	if in == nil {
		return nil
	}
	out := new(WaitForIPObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WaitForIPParameters) DeepCopyInto(out *WaitForIPParameters) {
	*out = *in
	if in.IPv4 != nil {
		in, out := &in.IPv4, &out.IPv4
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WaitForIPParameters.
func (in *WaitForIPParameters) DeepCopy() *WaitForIPParameters {
	if in == nil {
		return nil
	}
	out := new(WaitForIPParameters)
	in.DeepCopyInto(out)
	return out
}
