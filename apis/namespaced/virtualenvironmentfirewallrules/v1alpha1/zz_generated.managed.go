...
func (mg *EnvironmentFirewallRules) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this EnvironmentFirewallRules.
func (mg *EnvironmentFirewallRules) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *EnvironmentFirewallRules) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this EnvironmentFirewallRules.
func (mg *EnvironmentFirewallRules) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
