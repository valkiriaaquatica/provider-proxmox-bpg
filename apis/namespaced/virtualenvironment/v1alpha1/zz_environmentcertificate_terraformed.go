...
func (mg *EnvironmentCertificate) GetTerraformResourceType() string {
	return "proxmox_virtual_environment_certificate"
}
...
// LateInitialize this EnvironmentCertificate using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EnvironmentCertificate) LateInitialize(attrs []byte) (bool, error) {
	params := &EnvironmentCertificateParameters{}
